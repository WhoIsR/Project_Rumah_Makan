                                ...
                                @forelse ($categories as $category)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            @else
                                                <span class="text-gray-500">{{ $category->menu_items_count }}
                                                    Menu</span>
                                            @endif
                                        </td>
                ...
                button.addEventListener('click', async function() {
                    ...
                    try {
                        ...
                        const response = await fetch(
                            `/admin/categories/${categoryId}/menu-items`);
                        ...
                        if (menuItems.length === 0) {
                            modalBody.innerHTML =
                                '<p class="text-center text-gray-500">Tidak ada menu di kategori ini.</p>';
                            return;
                        }
                        ...
                        menuItems.forEach(menu => {
                            ...
                            li.className =
                                'flex items-center space-x-4 p-2 rounded-md hover:bg-gray-50';
                            li.innerHTML = `
                        ...
                        modalLoading.style.display = 'none';
                        modalBody.innerHTML =
                            '<p class="text-center text-red-500">Gagal memuat data menu.</p>';
                    }
                });
            });
        });
