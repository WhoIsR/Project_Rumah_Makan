                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('admin.ingredients.update', $ingredient) }}">
                        ...
                        <div>
                            ...
                            <!-- Stok Saat Ini -->
                            <div class="mt-4">
                            <label for="name" class="block font-medium text-sm text-gray-700">Stok Saat Ini</label>
                            ...
                            <!-- Satuan -->
                            <div class="mt-4">
                            <label for="name" class="block font-medium text-sm text-gray-700">Satuan (Contoh: gram, pcs, ml)</label>
