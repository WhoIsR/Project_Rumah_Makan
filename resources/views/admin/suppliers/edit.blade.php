                    ...
                    <form method="POST" action="{{ route('admin.suppliers.update', $supplier) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="address" name="address"
                                class="mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">{{ old('address', $supplier->address) }}</textarea>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('admin.suppliers.index') }}" class="text-sm text-gray-600 hover:text-gray-900 mr-4">
                                {{ __('Batal') }}
                            </a>
                            <x-primary-button>
                                {{ __('Simpan Perubahan') }}
