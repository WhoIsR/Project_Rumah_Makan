                ...
                <div class="p-6 md:p-8 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('admin.users.update', $user) }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 pt-4">
                            ...
                            {{-- PERUBAHAN DI SINI: justify-start diubah menjadi justify-center --}}
                            <div class="flex flex-col items-center justify-center pt-2">
                                ...
                                <img id="image-preview"
                                    ...
                                    alt="preview" class="w-28 h-28 rounded-full object-cover mb-4 shadow-md">
    ...
    <script>
        ...
        document.getElementById('profile_photo').addEventListener('change', function(event) {
            ...
            if (file) {
                ...
                // Jika file dihapus, kembalikan ke avatar default atau gambar lama
                const defaultAvatar = "{{ $user->profile_photo_path ? Storage::url($user->profile_photo_path) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&color=7F9CF5&background=EBF4FF' }}";
                document.getElementById('image-preview').src = defaultAvatar;
            }
        });
    </script>
</x-app-layout>