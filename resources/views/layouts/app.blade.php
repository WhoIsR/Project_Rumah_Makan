                ...
                <aside class="w-64 bg-gray-800 text-white min-h-screen p-4 flex-shrink-0">
                    ...
                    <nav>
                      ...
                      {{ request()->routeIs('dashboard') ? 'bg-amber-500 text-white font-bold' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                            ...
                            <li
                                class="px-4 pt-4 pb-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">Master Data</li>
                            <li>
                                <a
                          ...
                          {{ request()->routeIs('admin.users.*') ? 'bg-amber-500 text-white font-bold' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewbox="0 0 24 24">
                                        <path
                                            ...
                                            stroke-linejoin="round"
                                            stroke-width="2"
                                            d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M15 21a6 6 0 00-9-5.197M15 21a6 6 0 00-9-5.197"></path>
                                    </svg>
                                    <span>Pengguna</span>
                                </a>
                            </li>
                          ...
                          {{ request()->routeIs('admin.categories.*') ? 'bg-amber-500 text-white font-bold' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewbox="0 0 24 24">
                                        <path
                                            ...
                                            stroke-linejoin="round"
                                            stroke-width="2"
                                            d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 11h10"></path>
                                    </svg>
                            ...
                            <li
                                class="px-4 pt-4 pb-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">Transaksi</li>
                            <li>
                                <a
                            ...
                            <li
                                class="px-4 pt-4 pb-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">Laporan</li>
                            <li>
                                <a
                                    href="#"
                                    {{-- ganti # dengan route laporan nanti --}}
                        ...
                        <ul class="space-y-2 mt-8 pt-4 border-t border-gray-700">
                            <li>
                                <a
                                    ...
                                    {{-- target="_blank"  Uncomment jika ingin membuka di tab baru --}}
