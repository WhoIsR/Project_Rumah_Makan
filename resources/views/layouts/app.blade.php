        ...
        <aside id="sidebar"
            ...
            <div id="sidebar-header-container" class="border-b border-gray-700 w-full h-16 flex items-center">
                ...
                <div class="sidebar-brand-lg px-6">
                    <h1 class="text-2xl font-bold text-white">Resto Enak</h1>
                </div>
                {{-- Minimized Logo --}}
                <div class="sidebar-brand-sm">
                    <h1 class="text-2xl font-bold text-white">RE</h1>
                </div>
            </div>
            ...
            <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
                <ul class="flex-1 py-4 space-y-1">
                    ...
                    <li class="px-6 pt-4 pb-2 text-xs font-semibold text-gray-500 uppercase sidebar-text">Master Data
                    </li>
                    ...
                    <li class="px-6 pt-4 pb-2 text-xs font-semibold text-gray-500 uppercase sidebar-text">Transaksi</li>

                    {{-- Halaman Kasir (POS) --}}
                    <li>
                        <a href="{{ route('kasir.index') }}"
                            class="sidebar-link flex items-center h-12 rounded-md transition-colors {{ request()->routeIs('kasir.*') ? 'bg-amber-500 text-white font-bold' : 'hover:bg-gray-700 hover:text-white' }}">
                            <div class="sidebar-icon-wrapper w-14">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li class="px-6 pt-4 pb-2 text-xs font-semibold text-gray-500 uppercase sidebar-text">Laporan</li>

                    {{-- Laporan Penjualan --}}
                    <li>
                        <a href="{{ route('admin.reports.index') }}"
                            class="sidebar-link flex items-center h-12 rounded-md transition-colors {{ request()->routeIs('admin.reports.*') ? 'bg-amber-500 text-white font-bold' : 'hover:bg-gray-700 hover:text-white' }}">
                            <div class="sidebar-icon-wrapper w-14">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
